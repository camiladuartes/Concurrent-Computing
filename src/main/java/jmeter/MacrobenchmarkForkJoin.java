...
public class MacrobenchmarkForkJoin extends AbstractJavaSamplerClient implements Serializable {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        try {
        	IKNNimprov knn = new ForkAndJoinKNN(k, TRAIN_FILENAME, TEST_FILENAME, NUM_THREADS, NUM_INSTANCES_TRAIN, NUM_INSTANCES_TEST);
