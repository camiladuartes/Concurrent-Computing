...
public class MacrobenchmarkCallable extends AbstractJavaSamplerClient implements Serializable {
	
	@Override 
    public Arguments getDefaultParameters() {
		// Argumentos knn
        Arguments defaultParameters = new Arguments();
        defaultParameters.addArgument("k", "6324");
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        try {
        	IKNNimprov knn = new CallableAndFutureKNN(k, TRAIN_FILENAME, TEST_FILENAME, NUM_THREADS, NUM_INSTANCES_TRAIN, NUM_INSTANCES_TEST);
