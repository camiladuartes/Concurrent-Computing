...
public class MacrobenchmarkSerial extends AbstractJavaSamplerClient implements Serializable {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        try {
        	IKNN knn = new SerialKNN(k, TRAIN_FILENAME, TEST_FILENAME, NUM_INSTANCES_TRAIN, NUM_INSTANCES_TEST);
